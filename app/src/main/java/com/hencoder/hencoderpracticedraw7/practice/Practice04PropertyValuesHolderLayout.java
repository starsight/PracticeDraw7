    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder propertyValuesHolder1= PropertyValuesHolder.ofFloat("scaleX",1.0f);
                PropertyValuesHolder propertyValuesHolder2= PropertyValuesHolder.ofFloat("scaleY",1.0f);
                PropertyValuesHolder propertyValuesHolder3= PropertyValuesHolder.ofFloat("alpha",1.0f);
